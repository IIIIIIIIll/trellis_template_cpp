...
| `specs/cpp/cpp/*.md` | The product: 13 C++ guideline documents installed into consumer projects |
...
|---------------|------------|
| Editing any file under `specs/cpp/**` (the 13 guideline docs or their README) | [Guideline Authoring](./guideline-authoring.md) |
