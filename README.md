...
└── specs/cpp/
    ...
    ├── big-question/          ← consumer scar home: severity index + incident exemplars
...
The template's layer directories (`cpp/`, `guides/`, and `big-question/`)
become `.trellis/spec/cpp/`, `.trellis/spec/guides/`, and
`.trellis/spec/big-question/` after install; layer discovery picks all three
up automatically.
